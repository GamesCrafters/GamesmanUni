...
export const defaultImageAutoGUITheme:
    ImageAutoGUITheme = {
      space: [1, 1],
      centers: [[]],
      background: '',
...
export const defaultMatch: Types.Match = {
  ...
  marblePullActivated: false
};

export const VVHViews: Array<string> =
    ['Remoteness', 'Win By', 'Draw Level', 'Column'];
export const activeVVHViews: Array<Types.VVHView> = [{
  name: VVHViews[0],
  viewOptions:
      {togglePreferences: false, toggleScrolling: false, toggleGuides: true}
}];  // VVHViews[0] is set as the default view.

export const CPUStrategies: Array<string> =
    ['Remoteness', 'Win By', 'Skill Expression'];
export const defaultCPUsStrategies: Array<string> =
...
export const defaultApp: Types.App = {
  ...
  currentMatch: {
    ...
    animationPlaying: false,
    round:
        {...defaultRound, position: {...defaultPosition, availableMoves: {}}},
    backgroundLoading: false,
    computerMoving: false
  },

...
<script lang="ts" setup>
    ...
    watch(
        () => [store.state.app.preferences.theme, store.state.app.game.round.id, store.state.app.game.id, store.state.app.game.variant.id, store.state.app.game.round.position],
        () => drawVvh()
    );
</script>
